...
if($_SESSION['ks'])
	...
	if(count($oplata)>0)
		{
		$table="<H1>Отчёт по платежам за ".realday($kassir->otchet_day)."<H1>";
		...
		$table.="<H5><TABLE cellspacing=0 cellpadding=0><TR><TD>Итог: всего платежей <B>".$itog[0]."</B> на сумму <B>".$itog[1]."</B> руб.</TABLE></H5>";
